...
import fs from 'fs';
import { FileSystemDatasources } from "./file-system.datasource";
...
describe('FileSystemDatasource', () => {
    ...
    test('should save a log in logs-all.log', () => {
        ...
        const LogDatasource = new FileSystemDatasources();
    ...
    test('should save a log in logs-all.log and log-medium.log', () => {
    ...
    test('should save a log in logs-all.log and log-high.log', () => {
    ...
    test('should retusn all logs', async() => {
